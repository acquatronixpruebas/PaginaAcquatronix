<?php
// procesar_formulario_phpmailer.php
// Instalación: composer require phpmailer/phpmailer

// MODO DEBUG - Mostrar errores (comentar en producción)
...
if (!file_exists('vendor/autoload.php')) {
    die(json_encode([
        'success' => false,
        'message' => 'Error: PHPMailer no está instalado. Ejecuta: composer require phpmailer/phpmailer'
    ]));
}
...
// ====================================
// CONFIGURACIÓN DE EMAIL - EDITA AQUÍ
// ====================================
$config = [
    // Configuración para Outlook
    'smtp_host' => 'smtp-mail.outlook.com',      
    'smtp_port' => 587,
    'smtp_username' => 'acquatronix@outlook.com',
    'smtp_password' => '14Soporte',               
    
    'to_email' => 'soporte@acquatronix.com',    
    'from_name' => 'Formulario Acquatronix'
];
...
// Intentar enviar el email con PHPMailer
try {
    $mail = new PHPMailer(true); $mail->SMTPDebug = 2;  
$mail->Debugoutput = 'html';
    ...
    // Opcional: Para debugging (comentar en producción)
    // $mail->SMTPDebug = 2;
    ...
    // Contenido del email
    $mail->isHTML(true);
    $mail->Subject = "Nuevo mensaje de contacto - Acquatronix";
    ...
    $mail->AltBody = "
Nuevo mensaje de contacto - Acquatronix
...
---
Este mensaje fue enviado desde el formulario de contacto de Acquatronix
